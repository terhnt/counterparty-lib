...
from unopartylib.lib.backend import addrindex, btcd
...
def BACKEND():
    return sys.modules['unopartylib.lib.backend.{}'.format(config.BACKEND_NAME)] 
...
def get_btc_supply(normalize=False):
    """returns the total supply of {} (based on what Unobtanium Core says the current block height is)""".format(config.MAINCOIN)
