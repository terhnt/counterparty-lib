...
MAINCOIN_NAME = 'Unobtanium'
TOKEN_NAME = 'Unoparty'
APP_NAME = TOKEN_NAME.lower()

DEFAULT_BACKEND_PORT_TESTNET_UNOD = 65531
DEFAULT_BACKEND_PORT_UNOD = 65535
...
ESTIMATE_FEE_PER_KB = True               # when True will use `estimatefee` from unobtaniumd instead of DEFAULT_FEE_PER_KB
ESTIMATE_FEE_NBLOCKS = 3
DEFAULT_FEE_PER_KB_ESTIMATE_SMART = 1024
#ESTIMATE_FEE_CONF_TARGET = 3            # Currently using ESTIMATE_FEE_NBLOCKS, LATER VERSIONS USE THIS VARIABLE INSTEAD
...
VERIFY_CHECKPOINTS = True   # Later isnt used
VERIFY_STORED_HASH = True   # Later isnt used
...
# Below is used in later versions
