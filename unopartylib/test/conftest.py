...
from unopartylib.test.fixtures.vectors import UNITTEST_VECTOR
from unopartylib.test.fixtures.params import DEFAULT_PARAMS
from unopartylib.test.fixtures.scenarios import INTEGRATION_SCENARIOS

from unopartylib.lib import config, util, database, api, script, arc4
...
class MockUTXOSet(object):
    ...
    :type utxos list UTXOs list containing:
                        { 'address': 'Ukn3L4dgG13R3dSdxLvAAJizeiaW7cyUFz',
                          ...
                          'txhex': '',
...
def init_mock_functions(request, monkeypatch, mock_utxos, rawtransactions_db):
    ...
    monkeypatch.setattr('unopartylib.lib.transaction.arc4.init_arc4', init_arc4)
    monkeypatch.setattr('unopartylib.lib.backend.get_unspent_txouts', get_unspent_txouts)
    monkeypatch.setattr('unopartylib.lib.log.isodt', isodt)
    monkeypatch.setattr('unopartylib.lib.log.curr_time', curr_time)
    monkeypatch.setattr('unopartylib.lib.util.date_passed', date_passed)
    monkeypatch.setattr('unopartylib.lib.api.init_api_access_log', init_api_access_log)
    if hasattr(config, 'PREFIX'):
        monkeypatch.setattr('unopartylib.lib.config.PREFIX', b'TESTXXXX')
    monkeypatch.setattr('unopartylib.lib.backend.getrawtransaction', mocked_getrawtransaction)
    monkeypatch.setattr('unopartylib.lib.backend.getrawtransaction_batch', mocked_getrawtransaction_batch)
    monkeypatch.setattr('unopartylib.lib.backend.search_raw_transactions', mocked_search_raw_transactions)
    monkeypatch.setattr('unopartylib.lib.backend.pubkeyhash_to_pubkey', pubkeyhash_to_pubkey)
    monkeypatch.setattr('unopartylib.lib.backend.multisig_pubkeyhashes_to_pubkeys', multisig_pubkeyhashes_to_pubkeys)
