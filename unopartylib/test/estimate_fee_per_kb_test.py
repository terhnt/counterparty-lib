...
from unopartylib.test.fixtures.params import DEFAULT_PARAMS as DP, ADDR
from unopartylib.test.util_test import CURR_DIR
from unopartylib.test import util_test

from unopartylib.lib import (blocks, transaction, api, backend)
...
def test_estimate_fee_per_kb(fee_per_kb, fee_per_kb_used, server_db, monkeypatch):
    ...
    monkeypatch.setattr('unopartylib.lib.backend.fee_per_kb', _fee_per_kb)
