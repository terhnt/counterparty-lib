...
```
mv unopartylib/test/fixtures/scenarios/unittest_fixture.new.json unopartylib/test/fixtures/scenarios/unittest_fixture.json
mv unopartylib/test/fixtures/scenarios/unittest_fixture.new.sql unopartylib/test/fixtures/scenarios/unittest_fixture.sql
mv unopartylib/test/fixtures/scenarios/unittest_fixture.new.log unopartylib/test/fixtures/scenarios/unittest_fixture.log
```
...
UNITTEST_FIXTURE = [
    ...
    ['order', (ADDR[0], 'XUP', DP['quantity'], 'DIVISIBLE', DP['quantity'], 2000, 0), {'encoding': 'multisig'}],
    ['send', (ADDR[0], ADDR[1], 'DIVISIBLE', DP['quantity']), {'encoding': 'multisig'}, None],
    ['send', (ADDR[0], ADDR[1], 'XUP', DP['quantity']), {'encoding': 'multisig'}, None],
    ['order', (ADDR[0], 'XUP', DP['quantity'], 'DIVISIBLE', DP['quantity'], 2000, 0), {'encoding': 'multisig'}],
    ['order', (ADDR[0], 'XUP', DP['quantity'], 'UNO', round(DP['quantity'] / 100), 2000, DP['fee_required']), {'encoding': 'multisig'}],
    ['order', (ADDR[0], 'UNO', round(DP['quantity'] / 150), 'XUP', DP['quantity'], 2000, 0), {'encoding': 'multisig', 'fee_provided': DP['fee_provided']}],
    ['send', (ADDR[0], MULTISIGADDR[0], 'XUP', DP['quantity'] * 3), {'encoding': 'multisig'}, None],
    ...
    ['dispenser', (ADDR[5], 'XUP', 100, 100, 100, 0), {'encoding': 'opreturn'}],
    ...
    ['send', (ADDR[0], ADDR[1], 'XUP', DP['quantity'], 'hello', False, True), {'encoding': 'opreturn'}, {'enhanced_sends': True}],
    ['send', (ADDR[1], ADDR[0], 'XUP', DP['quantity'], 'fade0001', True, True), {'encoding': 'opreturn'}, {'enhanced_sends': True}],
    ...
    ['order', (ADDR[0], 'XUP', DP['quantity'], 'UNO', round(DP['quantity'] / 125), 2000, DP['fee_required']), {'encoding': 'multisig'}],
    ['order', (ADDR[1], 'UNO', round(DP['quantity'] / 125), 'XUP', DP['quantity'], 2000, 0), {'encoding': 'multisig', 'fee_provided': DP['fee_provided']}],
    ...
    ['send', (ADDR[2], ADDR[3], 'XUP', 92945878046), {'encoding': 'multisig'}, None],
...
def generate_standard_scenario(address1, address2, order_matches):
    ...
    return [
        ...
        ['send', (address1, address2, 'XUP', DP['small']), {'encoding': 'multisig'}, None],
        ['order', (address1, 'UNO', DP['small'], 'XUP', DP['small'] * 2, DP['expiration'], 0), {'encoding': 'multisig', 'fee_provided': DP['fee_provided']}],
        ['order', (address1, 'XUP', round(DP['small'] * 2.1), 'UNO', DP['small'], DP['expiration'], DP['fee_required']), {'encoding': 'multisig'}],
        ...
        ['dividend', (address1, 600, 'BBBB', 'XUP'), {'encoding': 'multisig'}],
        ['dividend', (address1, 800, 'BBBC', 'XUP'), {'encoding': 'multisig'}],
        ...
        ['order', (address1, 'BBBB', DP['small'], 'XUP', DP['small'], DP['expiration'], 0), {'encoding': 'multisig'}],
