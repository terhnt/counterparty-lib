...
def test_alice_bob(server_db):
    ...
    # balance before send
    alice_balance = util.get_balance(server_db, alice, 'XUP')
    bob_balance = util.get_balance(server_db, bob, 'XUP')
    assert alice_balance == 91875000000
    assert bob_balance == 0

    # create send
    v = int(100 * 1e8)
    send1hex = util.api('create_send', {'source': alice, 'destination': bob, 'asset': 'XUP', 'quantity': v})
    assert send1hex == ""

    # insert send, this automatically also creates a block
    tx1hash, tx1 = util_test.insert_raw_transaction(send1hex, server_db)

    # balances after send
    alice_balance2 = util.get_balance(server_db, alice, 'XUP')
    bob_balance2 = util.get_balance(server_db, bob, 'XUP')
    ...
    # create send
    v = int(100 * 1e8)
    send2hex = util.api('create_send', {'source': alice, 'destination': bob, 'asset': 'XUP', 'quantity': v})
    assert send2hex == ""
    ...
    # create send
    v = int(100 * 1e8)
    send3hex = util.api('create_send', {'source': alice, 'destination': bob, 'asset': 'XUP', 'quantity': v})
    assert send3hex == ""
